...
use Awsw\Gesi\Formularios\MensajeSecretaria\CreacionSinSesion as Formulario;

class InvCrear extends Modelo
{
	...
	public function __construct()
	{
        ...
        $this->formulario = new Formulario('/secretaria/crear/');
