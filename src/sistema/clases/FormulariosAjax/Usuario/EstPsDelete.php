...
/**
 * Formulario AJAX para eliminar un usuario estudiante por parte de 
 ...
 */
 ...
 class EstPsDelete extends FormularioAjax
 {
     ...
     */
    private const FORM_ID = 'usuario-est-ps-delete';
    ...
    public function processSubmit(array $data = array()): void
    {
        ...
        $restricciones = Usuario::dbCompruebaRestricciones($uniqueId);
